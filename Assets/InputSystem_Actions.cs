...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""KartDrive"",
            ""id"": ""95abe6b1-f270-4272-bba9-3dea80d800b2"",
            ""actions"": [
                {
                    ""name"": ""Steer"",
                    ""type"": ""Value"",
                    ""id"": ""09f6b093-03dd-41ae-9352-9e86c3cc5e40"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8ed06fe9-7dbb-4dea-8b12-78914187a1d4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fa74dffd-ea00-4c1d-ad18-b880a8af1490"",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""64228c35-dbca-468d-b6c2-7fd4ac5aa050"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""a43c217a-0c55-4a80-975f-c72997310276"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""daabfa4e-709d-4e8f-ab27-d28ef4e07c41"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // KartDrive
        m_KartDrive = asset.FindActionMap("KartDrive", throwIfNotFound: true);
        m_KartDrive_Steer = m_KartDrive.FindAction("Steer", throwIfNotFound: true);
        // Player
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_KartDrive.enabled, "This will cause a leak and performance issues, InputSystem_Actions.KartDrive.Disable() has not been called.");
    ...
    // KartDrive
    private readonly InputActionMap m_KartDrive;
    private List<IKartDriveActions> m_KartDriveActionsCallbackInterfaces = new List<IKartDriveActions>();
    private readonly InputAction m_KartDrive_Steer;
    /// <summary>
    /// Provides access to input actions defined in input action map "KartDrive".
    /// </summary>
    public struct KartDriveActions
    {
        ...
        /// </summary>
        public KartDriveActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "KartDrive/Steer".
        /// </summary>
        public InputAction @Steer => m_Wrapper.m_KartDrive_Steer;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_KartDrive; }
        ...
        /// <summary>
        /// Implicitly converts an <see ref="KartDriveActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(KartDriveActions set) { return set.Get(); }
        /// <summary>
        ...
        /// </remarks>
        /// <seealso cref="KartDriveActions" />
        public void AddCallbacks(IKartDriveActions instance)
        {
            if (instance == null || m_Wrapper.m_KartDriveActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_KartDriveActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="KartDriveActions" />
        private void UnregisterCallbacks(IKartDriveActions instance)
        {
            @Steer.started -= instance.OnSteer;
            @Steer.performed -= instance.OnSteer;
            @Steer.canceled -= instance.OnSteer;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="KartDriveActions.UnregisterCallbacks(IKartDriveActions)" />.
        /// </summary>
        /// <seealso cref="KartDriveActions.UnregisterCallbacks(IKartDriveActions)" />
        public void RemoveCallbacks(IKartDriveActions instance)
        {
            if (m_Wrapper.m_KartDriveActionsCallbackInterfaces.Remove(instance))
        ...
        /// </remarks>
        /// <seealso cref="KartDriveActions.AddCallbacks(IKartDriveActions)" />
        /// <seealso cref="KartDriveActions.RemoveCallbacks(IKartDriveActions)" />
        /// <seealso cref="KartDriveActions.UnregisterCallbacks(IKartDriveActions)" />
        public void SetCallbacks(IKartDriveActions instance)
        {
            foreach (var item in m_Wrapper.m_KartDriveActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_KartDriveActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="KartDriveActions" /> instance referencing this action map.
    /// </summary>
    public KartDriveActions @KartDrive => new KartDriveActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "KartDrive" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="KartDriveActions.AddCallbacks(IKartDriveActions)" />
    /// <seealso cref="KartDriveActions.RemoveCallbacks(IKartDriveActions)" />
    public interface IKartDriveActions
    {
        /// <summary>
